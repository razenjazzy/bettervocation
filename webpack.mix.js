...
mix.js([
    ...
    ], 'public/frontend/bettervocationtheme/js/app.js')
    .sass('resources/sass/frontend/default/app.scss', 'public/frontend/bettervocationtheme/css/app.css')
    .sass('resources/sass/frontend/default/frontend_style.scss', 'public/frontend/bettervocationtheme/css/frontend_style.css');
...
mix.js([
    ...
    ], 'public/js/certificate/certificate.js')
    .js([
        'resources/js/certificate/student_main.js',
        'resources/js/certificate/custom.js',
    ], 'public/js/certificate/student_certificate.js')