...
class ClassDetailsPageSection extends Component
{
    ...
    public function render()
    {
        ...
        return view(theme('components.class-details-page-section'), $data, compact('userRating', 'certificateCanDownload', 'isWaiting', 'is_cart', 'reviewer_user_ids', 'related', 'isFree', 'isBookmarked', 'isEnrolled'));
    }
}
