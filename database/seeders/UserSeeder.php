...
class UserSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $user->email = 'teacher@bettervocation.io';
        $user->username = 'teacher@bettervocation.io';
        ...
        $user->role_id = 3;
        $user->name = 'Student';
        $user->email = 'student@bettervocation.io';
        $user->username = 'student@bettervocation.io';
        ...
        \App\User::insert(
            ['name' => 'Robert Pattinson',
                ...
                'role_id' => '2',
                'email' => 'instructor2@bettervocation.io',
        ...
        \App\User::insert(
            ...
            ['name' => 'Johnny Depp',
                ...
                'role_id' => '2',
                'email_verified_at' => now(),
                'email' => 'instructor3@bettervocation.io',
                'password' => bcrypt('12345678'),
                'email_verify' => 1,
                'currency_id' => 1,
        ...
        \App\User::insert(
            ['name' => 'Bradley Cooper',
                ...
                'role_id' => '2',
                'email_verified_at' => now(),
                'email' => 'instructor4@bettervocation.io',
                'password' => bcrypt('12345678'),
                'email_verify' => 1,
                'currency_id' => 1,
        ...
        \App\User::insert(['name' => 'Carlie Jhovis',
            ...
            'role_id' => '3',
            'email_verified_at' => now(),
            'email' => 'student2@bettervocation.io',
            'password' => bcrypt('12345678'),
            'email_verify' => 1,
            'currency_id' => 1,
            'balance' => 500,
        ...
        for ($i = 0; $i < 50; $i++) {
            \App\User::insert(
                ['name' => 'Instructor' . $i,
                    ...
                    'role_id' => '2',
                    'email_verified_at' => now(),
                    'email' => 'instructor4' . $i . '@bettervocation.io',
                    'password' => bcrypt('12345678'),
                    'email_verify' => 1,
                    'currency_id' => 1,
                    'headline' => 'Creative Director',
        ...
        for ($j = 0; $j < 50; $j++) {
            \App\User::insert(
                ['name' => 'Student' . $j,
                    ...
                    'role_id' => '3',
                    'email_verified_at' => now(),
                    'email' => 'student3' . $j . '@bettervocation.io',
                    'password' => bcrypt('12345678'),
                    'email_verify' => 1,
                    'currency_id' => 1,
                    'headline' => 'Creative Director',
