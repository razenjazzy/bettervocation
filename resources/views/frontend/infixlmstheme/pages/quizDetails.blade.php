...
@section('title'){{Settings('site_title')  ? Settings('site_title')  : 'Better Vocation'}} |  {{$course->title}} @endsection
...
@section('css')
    ...
    <link rel="stylesheet" href="{{asset('public/frontend/bettervocationtheme/css/class_details.css')}}"/>
    <link rel="stylesheet" href="{{asset('public/frontend/bettervocationtheme/css/quiz_details.css')}}"/>
@endsection
...
@section('js')
    ...
    <script src="{{ asset('public/frontend/bettervocationtheme/js/quiz_details.js') }}"></script>
