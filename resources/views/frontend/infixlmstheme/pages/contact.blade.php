...
@section('title'){{Settings('site_title')  ? Settings('site_title')  : 'Better Vocation'}} | {{__('frontend.Contact Us')}} @endsection
...
@section('js')
    ...
    <script src="{{ asset('public/frontend/bettervocationtheme') }}/js/map.js"></script>
    <script src="{{asset('public/frontend/bettervocationtheme/js/contact.js')}}"></script>
@endsection
