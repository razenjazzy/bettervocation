...
@section('title')
    {{Settings('site_title')  ? Settings('site_title')  : 'Better Vocation'}} | {{ $course->title}}
@endsection
@section('css')
    <link href="{{asset('public/frontend/bettervocationtheme/css/full_screen.css')}}" rel="stylesheet"/>
...
@section('mainContent')
    ...
    <div class="course_fullview_wrapper">
        ...
        @else
            ...
            @if ($lesson->host=='PDF')
                <script src="{{asset('public/frontend/bettervocationtheme/js/pdf.min.js')}}"></script>
                <script src="{{asset('public/frontend/bettervocationtheme/js/pdfjs-viewer.js')}}"></script>
                <link rel="stylesheet" href="{{asset('public/frontend/bettervocationtheme/css/pdfjs-viewer.css')}}"/>

                <script>
                    var pdfjsLib = window['pdfjs-dist/build/pdf'];
                    pdfjsLib.GlobalWorkerOptions.workerSrc = '{{asset('public/frontend/bettervocationtheme/js/pdf.worker.min.js')}}';
                </script>
...
@push('js')
    ...
    <script src="{{asset('public/frontend/bettervocationtheme/js/full_screen_video.js')}}"></script>
    @if ($lesson->is_quiz==1)
        @if(!$result)
            <script src="{{ asset('public/frontend/bettervocationtheme/js/quiz_start.js') }}"></script>
        @endif
    @endif
