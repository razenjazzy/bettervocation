...
@section('title'){{Settings('site_title')  ? Settings('site_title')  : 'Better Vocationcationcationcationcationcationcationcationcationcationcationcationcationcationcationcationcationcationcationcationcationcationcationcationcationcationcationcationcationcationcationcation'}} |  {{$course->title}} @endsection
...
@section('css')
    ...
    <link href="{{asset('public/frontend/bettervocationtheme/css/videopopup.css')}}" rel="stylesheet"/>
    <link href="{{asset('public/frontend/bettervocationtheme/css/video.popup.css')}}" rel="stylesheet"/>
...
@section('js')
    ...
    <script src="{{asset('public/frontend/bettervocationtheme/js/videopopup.js')}}"></script>
    <script src="{{asset('public/frontend/bettervocationtheme/js/video.popup.js')}}"></script>
