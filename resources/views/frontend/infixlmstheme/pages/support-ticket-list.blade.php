...
@section('title'){{Settings('site_title')  ? Settings('site_title')  : 'Better Vocation'}} | {{__('ticket.support_ticket')}} @endsection
@section('css')
    <link rel="stylesheet" href="{{asset('public/frontend/bettervocationtheme/css/support.css')}}">
@endsection
@section('js')
    <script src="{{asset('public/frontend/bettervocationtheme/js/support.js')}}"> </script>
@endsection
        ...
        <div class="support_main_card_title mobile_wrap">
            ...
            <div class="support_main_card_title_tabs">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="closed-tab" data-toggle="tab" data-target="#closed" type="button"
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="all-tricket-tab" data-toggle="tab" data-target="#all-tricket"
                                type="button" role="tab" aria-controls="all-tricket" aria-selected="true">All Tricket
                        </button>
                    </li>
                </ul>
            </div>
                                    ...
                                    <td>
                                        ...
                                        <span id="table_action">
                                                <a href="{{route('student.support-ticket.show',$ticket->id)}}"
                                                   class='theme_btn'><i
                                                        class="ti ti-eye"></i></a>
                                                <a href="{{route('student.support-ticket.edit',$ticket->id)}}" class='theme_btn'><i class="ti ti-pencil-alt"></i></a>
                                            </span>
                                    </td>
                                </tr>
                            @empty
                                <tr>
                                    <td colspan="6">
                                        <b class="text-center">{{__(trans('ticket.no_ticket_found'))}}</b>
                                    </td>
                                </tr>
                            @endforelse
