...
@section('title')
    {{Settings('site_title')  ? Settings('site_title')  : 'Better Vocation'}} | {{__('survey.Survey')}}
@endsection
@section('css')
                                            ...
                                            <div class="col-lg-12 d-flex mt-5">
                                                        ...
                                                        @for ($i=1; $i<=$option;$i++)
                                                            <li class="d-inline-block text-center mr-3">
                                                                ...
                                                                <label class="primary_bulet_checkbox d-flex">
                                                                    <input type="radio" value="{{$i}}" name="survey_answer[{{$question->id}}]"
                                                ...
                                                @elseif ($question->type=='dropdown')
                                                    <div class="single_input ">
                                                        ...
                                                        <select class="select2 mb-3 wide w-100"
                                                            ...
                                                            <option data-display="Select Answer" value="#">{{__('common.Select')}} {{__('common.Answer')}}
                                                ...
                                                @else
                                                    <div class="input-effect mb-20">
                                                        <label class="primary_input_label"> {{__('common.Answer')}}
                                                            <strong
