                                                            ...
                                                            <div class="marking_img">
                                                                @if(isset($question['isSubmit']))
                                                                    @if(isset($question['isWrong']) &&  $question['isWrong'])
                                                                        <img
                                                                            src="{{asset('public/frontend/bettervocationtheme')}}/img/course_details/wrong.png"
                                                                            alt="">
                                                                    @else
                                                                        <img
                                                                            src="{{asset('public/frontend/bettervocationtheme')}}/img/course_details/correct.png"
                                                                            alt="">
                                                                    @endif
                                                                @else
                                                                    <img
