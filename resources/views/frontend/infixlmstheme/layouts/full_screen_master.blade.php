...
<head>
    ...
    <title>
        {{Settings('site_title')  ? Settings('site_title')  : 'Better Vocation'}}
    </title>
    ...
    <link rel="stylesheet" href="{{ asset('public/frontend/bettervocationtheme') }}/css/fluidplayer.min.css">

    {{--    <link rel="stylesheet" href="{{asset('public/backend/css/style.css')}}"/>--}}
    <link rel="stylesheet" href="{{asset('public/css/preloader.css')}}"/>

    <link rel="stylesheet" href="{{ asset('public/frontend/bettervocationtheme') }}/css/app.css">
    <link rel="stylesheet" href="{{ asset('public/frontend/bettervocationtheme') }}/css/frontend_style.css">
    <link rel="stylesheet" href="{{ asset('public/frontend/bettervocationtheme') }}/css/fontawesome.css ">
    <link rel="stylesheet" href="{{asset('public/backend/css/themify-icons.css')}}"/>
    <script src="{{asset('public/js/common.js')}}"></script>
    {{--    <script src="{{asset('public/frontend/bettervocationtheme/js/app.js')}}"></script>--}}
    @yield('css')
    <script>
...
<script src="{{ asset('public/frontend/bettervocationtheme') }}/js/fluidplayer.min.js"></script>
