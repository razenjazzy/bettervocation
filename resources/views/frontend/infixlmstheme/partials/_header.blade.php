...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('public/frontend/bettervocationtheme') }}/css/fontawesome.css{{assetVersion()}} ">
    <link rel="stylesheet" href="{{asset('public/backend/css/themify-icons.css')}}{{assetVersion()}}"/>
    <link rel="stylesheet" href="{{ asset('public/frontend/bettervocationtheme') }}/css/flaticon.css{{assetVersion()}}">
    <link rel="stylesheet" href="{{ asset('public/frontend/bettervocationtheme') }}/css/nice-select.css{{assetVersion()}}">
    <link rel="stylesheet" href="{{ asset('public/frontend/bettervocationtheme') }}/css/notification.css{{assetVersion()}}">
    <link rel="stylesheet" href="{{ asset('public/frontend/bettervocationtheme/css/mega_menu.css') }}">
    ...
    <link rel="stylesheet" href="{{ asset('public/frontend/bettervocationtheme') }}/css/app.css{{assetVersion()}}"
          media="screen,print">
    <link rel="stylesheet" href="{{ asset('public/frontend/bettervocationtheme') }}/css/frontend_style.css{{assetVersion()}}"
          media="screen,print">
