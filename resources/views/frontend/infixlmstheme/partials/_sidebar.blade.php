                ...
                <li>
                    <a href="{{route('studentDashboard')}}"
                       class="  d-flex align-items-center {{ routeIs('studentDashboard')  ? 'active' : '' }}">
                        <div class="menu_icon">
                            <img src="{{asset('/public/frontend/bettervocationtheme/')}}/img/svg/dashboard.svg" alt="">
                        </div>
                ...
                <li>
                    <a href="{{route('myCourses')}}"
                       class=" d-flex align-items-center {{ routeIs('myCourses')  ? 'active' : '' }}">
                        <div class="menu_icon">
                            <img src="{{asset('/public/frontend/bettervocationtheme/')}}/img/svg/my_course.svg" alt="">
                        </div>
                ...
                <li>
                    <a href="{{route('myClasses')}}"
                       class=" d-flex align-items-center {{ routeIs('myClasses')  ? 'active' : '' }}">
                        <div class="menu_icon">
                            <img src="{{asset('/public/frontend/bettervocationtheme/')}}/img/svg/my_quiz.svg" alt="">
                        </div>
                ...
                <li>
                    <a href="{{route('myReports')}}"
                       class=" d-flex align-items-center {{ routeIs('myReports')  ? 'active' : '' }}">
                        <div class="menu_icon">
                            <img src="{{asset('/public/frontend/bettervocationtheme/')}}/img/svg/my_report.svg" alt="">
                        </div>
            ...
            <li>
                <a href="{{route('myNotificationSetup')}}"
                   class=" d-flex align-items-center  {{ routeIs('myNotificationSetup')  ? 'active' : '' }}">
                    <div class="menu_icon">
                        <img src="{{asset('/public/frontend/bettervocationtheme/')}}/img/svg/purchase_history.svg" alt="">
                    </div>
                ...
                <li>
                    <a href="{{route('myProfile')}}"
                       class=" d-flex align-items-center {{ routeIs('myProfile')  ? 'active' : '' }}">
                        <div class="menu_icon">
                            <img src="{{asset('/public/frontend/bettervocationtheme/')}}/img/svg/edit_pro.svg" alt="">
                        </div>
                ...
                <li>
                    <a href="{{route('myAccount')}}"
                       class=" d-flex align-items-center {{ routeIs('myAccount')  ? 'active' : '' }}">
                        <div class="menu_icon">
                            <img src="{{asset('/public/frontend/bettervocationtheme/')}}/img/svg/account_setting.svg" alt="">
                        </div>
