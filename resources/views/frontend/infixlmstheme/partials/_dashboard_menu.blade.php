            ...
            <ul>
                <li class="position-relative">
                    <a href="#" class="show_notify">
                        <div class="notify_icon">
                            <img src="{{asset('/public/frontend/bettervocationtheme/')}}/img/svg/bell.svg" alt="">
                            {{-- <i class="ti-bell"></i> --}}
                        </div>
                ...
                <li>
                    <a href="{{route('myWishlists')}}">
                        <div class="notify_icon">
                            <img src="{{asset('/public/frontend/bettervocationtheme/')}}/img/svg/heart.svg" alt="">
                        </div>
                ...
                <li>
                    <a href="#" class="cart_store">
                        <div class="notify_icon">
                            <img class="" src="{{asset('/public/frontend/bettervocationtheme/')}}/img/svg/cart.svg" alt="">
                        </div>
