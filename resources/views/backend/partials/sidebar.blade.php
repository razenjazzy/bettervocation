...
<nav id="sidebar" class="sidebar ">
    ...
    <ul id="sidebar_menu">
        ...
        @else
            ...
            @if (isModuleActive('CertificatePro') && permissionCheck('certificate_pro.index'))
                @include('certificatepro::menu')
            @endif
                        ...
                        <li>
                            ...
                            <ul>
                                ...
                                @if (permissionCheck('course-level.index'))
                                    <li><a href="{{ route('course-level.index') }}">{{ __('courses.Course Level') }}</a>
                                    </li>
                                @endif
                ...
                @if (permissionCheck('courses'))
                    <li>
                        ...
                        <ul>
                            ...
                            @else
                                @if (permissionCheck('course.setting'))
                                    <li>
                                        <a href="{{ route('course.setting') }}"> {{ __('frontendmanage.Course Setting') }}</a>
                                    </li>
                                @endif
                            @endif
                        </ul>
            ...
            @if(permissionCheck('notification'))
                <li>
                    <a href="#" class="has-arrow" aria-expanded="false">
                        <div class="nav_icon_small">
...
{{ __('setting.Push Notification') }}
            ...
            @endif
            @if (!isModuleActive('LmsSaas') && permissionCheck('utility'))
                <li>
                    <a href="#" class="has-arrow" aria-expanded="false">
                        <div class="nav_icon_small">
                ...
                @if (permissionCheck('user.manager') )
                    <li>
                        ...
                        <ul>
                            ...
                            @endif
                            @if (permissionCheck('permission.student-roles') && isModuleActive('OrgInstructorPolicy'))
                                <li>
                                    <a href="{{ route('permission.student-roles') }}">{{ __('role.Student Role') }}</a>
                                </li>
                            @endif

                            @if (!isModuleActive('Org') && permissionCheck('staffs.settings'))
                                <li>
            ...
            @if (permissionCheck('settings'))
                <li>
                    ...
                    <ul>
                        ...
                        @endif
                        @if (permissionCheck('setting.setCommission') && showEcommerce())
                            <li>
