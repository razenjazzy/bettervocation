...
class AddDeatialsInfoForModules extends Migration
{
    ...
    public function up()
    {
        ...
        if ($module) {
            $module->details = 'Add Tax functionality in BetterVocation System. Admin can set tax percentage. Admin can Add country based tax percentage. When students buy any Item, the Tax will be applied. Tax can enable/disable/change anytime.';
            $module->save();
        }
