        ...
        <div class="container-fluid">
            <div class="row justify-content-between">
                ...
                <div class="bc-pages">
                    ...
                    <a href="#">{{ __('setting.Notification') }}</a>
                    <a class="active"
                       href="{{route('notification_setup_list')}}">{{ __('setting.Notification Setup') }}</a>
                </div>
            </div>
        </div>
    </section>
                        ...
                        <div class="QA_table ">
                            ...
                            <form action="{{route('update_notification_setup')}}" name="notification_setup_form"
                                ...
                                <div class="col-lg-12 mt-30 text-center">
                                    <button class="primary-btn fix-gr-bg" type="submit" data-toggle="tooltip" title="">
