                                    ...
                                    <div class="col-md-12 item_list">
                                        ...
                                        @foreach($blocks as $block)
                                                                        ...
                                                                        <div class="primary_input mb-25">
                                                                            <div id="show_banner_section_box"
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    @endif
                                                                                    @if($currentTheme=="bettervocationtheme")
                                                                                        <div class="col-xl-3">
                                            ...
                                            @elseif($block->id==2)
                                                ...
                                                @endif
                                            @elseif($block->id==3)
                                                @if($currentTheme=="bettervocationtheme" || $currentTheme=='tvt' || $currentTheme=="teachery")
                                                    <div data-id="{{$block->id}}" class="row">
                                                        <div class="accordion" id="accordionHomeContent">
                                                            <div class="card">
                                                ...
                                                @endif
                                            @elseif($block->id==4)
                                                @if($currentTheme=="bettervocationtheme" || $currentTheme=="teachery")
                                                    <div data-id="{{$block->id}}" class="row">
                                                        <div class="accordion" id="accordionHomeContent">
                                                            <div class="card">
                                                                <div class="card-header"
                                            ...
                                            @elseif($block->id==13)
                                                @if(Settings('frontend_active_theme')!='bettervocationtheme')
                                                    <div data-id="{{$block->id}}" class="row">
                                                        <div class="accordion" id="accordionHomeContent">
                                                            <div class="card">
                                                                <div class="card-header"
                                                                                        ...
                                                                                        <div class="row">
                                                                                            <div class="col-xl-12">
                                                                                                <div
                                                                                                    ...
                                                                                                    <label
                                                                                                        class="primary_input_label"
                                                                                                        for="">{{ __('frontendmanage.Cta Header') }}
                                                                                                    </label>
                                                                                                    <input
                                                                                                        class="primary_input_field"
                                                                                            ...
                                                                                            <div class="col-xl-12">
                                                                                                <div
                                                                                                    ...
                                                                                                    <label
                                                                                                        class="primary_input_label"
                                                                                                        for="">
                                                                                                        {{ __('frontendmanage.Cta Upper Title') }}
                                                                                                    </label>
                                                                                                    <input
                                                                                                        class="primary_input_field"
                                                                                            ...
                                                                                            <div class="col-xl-12">
                                                                                                <div
                                                                                                    ...
                                                                                                    <label
                                                                                                        class="primary_input_label"
                                                                                                        for="">
                                                                                                        {{ __('frontendmanage.Cta Lower Title') }}
                                                                                                    </label>
                                                                                                    <input
                                                                                                        class="primary_input_field"
