...
class AddColumnIntoLoginPage extends Migration
{
    ...
    public function up()
    {
        Schema::table('login_pages', function ($table) {
            ...
            if (!Schema::hasColumn('login_pages', 'reg_title')) {
                $table->string('reg_banner')->default('public/frontend/bettervocationtheme/img/banner/global.png');
            }
            if (!Schema::hasColumn('login_pages', 'reg_title')) {
            ...
            if (!Schema::hasColumn('login_pages', 'forget_title')) {
                $table->string('forget_banner')->default('public/frontend/bettervocationtheme/img/banner/global.png');
            }
            if (!Schema::hasColumn('login_pages', 'forget_title')) {
