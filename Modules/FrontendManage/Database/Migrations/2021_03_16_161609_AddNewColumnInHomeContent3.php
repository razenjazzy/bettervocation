    ...
    public function up()
    {
        ...
        Schema::table('home_contents', function ($table) {
            if (!Schema::hasColumn('home_contents', 'key_feature_logo1')) {
                $table->string('key_feature_logo1')->default('public/frontend/bettervocationtheme/img/svg/course_1.svg');
            }
        });
        ...
        Schema::table('home_contents', function ($table) {
            if (!Schema::hasColumn('home_contents', 'key_feature_logo2')) {
                $table->string('key_feature_logo2')->default('public/frontend/bettervocationtheme/img/svg/course_2.svg');
            }
        });
        ...
        Schema::table('home_contents', function ($table) {
            if (!Schema::hasColumn('home_contents', 'key_feature_logo3')) {
                $table->string('key_feature_logo3')->default('public/frontend/bettervocationtheme/img/svg/course_3.svg');
            }
        });
