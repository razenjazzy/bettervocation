    ...
    public function up()
    {
        Schema::table('home_contents', function ($table) {
            ...
            if (!Schema::hasColumn('home_contents', 'instructor_banner')) {
                $table->string('instructor_banner')->default('public/frontend/bettervocationtheme/img/banner/cta_bg.jpg');
            }
            ...
            if (!Schema::hasColumn('home_contents', 'best_category_banner')) {
                $table->string('best_category_banner')->default('public/frontend/bettervocationtheme/img/banner/backage_bg.jpg');
            }
            ...
            if (!Schema::hasColumn('home_contents', 'subscribe_logo')) {
                $table->string('subscribe_logo')->default('public/frontend/bettervocationtheme/img/book.png');
            }
...
//---------------------
            ...
            if (!Schema::hasColumn('home_contents', 'course_page_banner')) {
                $table->string('course_page_banner')->default('public/frontend/bettervocationtheme/img/banner/bradcam_bg_1.jpg');
            }
...
//---------------------
            ...
            if (!Schema::hasColumn('home_contents', 'class_page_banner')) {
                $table->string('class_page_banner')->default('public/frontend/bettervocationtheme/img/banner/bradcam_bg_2.jpg');
            }
...
//---------------------
            ...
            if (!Schema::hasColumn('home_contents', 'quiz_page_banner')) {
                $table->string('quiz_page_banner')->default('public/frontend/bettervocationtheme/img/banner/bradcam_bg_3.jpg');
            }
            ...
            if (!Schema::hasColumn('home_contents', 'instructor_page_banner')) {
                $table->string('instructor_page_banner')->default('public/frontend/bettervocationtheme/img/banner/bradcam_bg_4.jpg');
            }
            ...
            if (!Schema::hasColumn('home_contents', 'contact_page_banner')) {
                $table->string('contact_page_banner')->default('public/frontend/bettervocationtheme/img/banner/bradcam_bg_5.jpg');
            }
            //---------------------
            ...
            if (!Schema::hasColumn('home_contents', 'about_page_banner')) {
                $table->string('about_page_banner')->default('public/frontend/bettervocationtheme/img/banner/bradcam_bg_6.jpg');
            }
            ...
            if (!Schema::hasColumn('home_contents', 'become_instructor_logo')) {
                $table->string('become_instructor_logo')->default('public/frontend/bettervocationtheme/img/services/1.png');
            }
