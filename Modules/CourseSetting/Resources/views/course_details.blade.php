                                        ...
                                        <div class="white_box_30px pl-0 pr-0 pt-0">
                                            <form action="{{route('AdminUpdateCourse')}}" method="POST"
                                                ...
                                                <div class="row">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-4 col-sm-6 mb-25">
                                                                        <label class="primary_checkbox d-flex mr-12">
                                                                            ...
                                                                            <span
                                                                                class="checkmark mr-2"></span> {{__('courses.Open')}}
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    @endif
                                                    <div class="{{$required_type?'col-xl-4':'col-xl-6'}} dripCheck"
                                                    ...
                                                    <div class="col-xl-6">
                                                        <div class="primary_input mb-25">
                                                            ...
                                                            <select name="assistant_instructors[]"
                                                                ...
                                                                @foreach ($instructors as $instructor)
                                                                    <option
                                                                        value="{{$instructor->id}}" {{!empty($course->assistantInstructorsIds) && in_array($instructor->id,$course->assistantInstructorsIds)?'selected':''}}>{{@$instructor->name}} </option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                                                        ...
                                                        @if (courseSetting()->show_mode_of_delivery==1 || isModuleActive('Org'))
                                                            <div class="col-xl-{{$col_size}}   mb-25">
                                                                <select class="primary_select mode_of_delivery"
                                                                    ...
                                                                    @else
                                                                        <option
                                                                            value="3" {{$course->mode_of_delivery==3?'selected':''}}>{{__('courses.Offline')}}</option>
                                                                    @endif
                                                            ...
                                                            @push('js')
                                                                <script>
                                                                    $('.category_id').change(function () {
                                                                        ...
                                                                        } else if ((category_id === 'Self') || (category_id === 'Zip') || (category_id === 'GoogleDrive') || (category_id === 'PowerPoint') || (category_id === 'Excel') || (category_id === 'Text') || (category_id === 'Word') || (category_id === 'PDF') || (category_id === 'Image') || (category_id === 'AmazonS3') || (category_id === 'SCORM') || (category_id === 'SCORM-AwsS3') || (category_id === 'XAPI') || (category_id === 'XAPI-AwsS3')) {
                                                        ...
                                                        <div class="col-xl-6">
                                                            <div class="primary_input mb-35">
                                                                <label class="primary_input_label mt-1"
                                                                    ...
                                                                    ({{__('common.Max Image Size 1MB')}}) (Recommend
                                                                    size: 1170x600)</label>
                                                                <div class="primary_file_uploader">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#category_id1').change(function () {
                ...
                } else if ((category_id1 === 'Self') || (category_id === 'Document') || (category_id === 'Image') || (category_id1 === 'AmazonS3') || (category_id1 === 'SCORM') || (category_id1 === 'SCORM-AwsS3') || (category_id1 === 'XAPI') || (category_id1 === 'XAPI-AwsS3')) {
                    $("#fileupload1").show();
                    $("#videoUrl1").hide();
                    $("#vimeoUrl1").hide();
                    $("#vimeoVideo1").val('');
