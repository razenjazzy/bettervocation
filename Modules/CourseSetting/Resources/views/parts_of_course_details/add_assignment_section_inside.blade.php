                                                        ...
                                                        <div class="primary_input mb-35">
                                                            ...
                                                            <div class="primary_file_uploader">
                                                                <input class="primary-input imgName" type="text"
                                                                       id="placeholderFile00"
                                                                       placeholder="{{isset($edit)? showPicName($edit->attachment) : e(__('common.Browse')).' '.e(__('assignment.Attachment'))}}"
                                                                       readonly="">
                                                                <button class="" type="button">
                                                                    <label class="primary-btn small fix-gr-bg"
                                                                           for="assignment_add_file">{{__('common.Browse')}}</label>
                                                                    <input type="file" class="d-none imgBrowse assignment_add_file" data-placeholder_filed="00" name="attachment"
                                                                           id="assignment_add_file">
                                                                </button>
                                                            </div>
                                                        </div>
                                                    </div>
