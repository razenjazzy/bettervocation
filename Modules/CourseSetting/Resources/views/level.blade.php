    ...
    <section class="sms-breadcrumb mb-40 white-box">
        <div class="container-fluid">
            <div class="row justify-content-between">
                <h1>{{__('courses.Course')}} {{__('courses.Level')}}</h1>
                <div class="bc-pages">
                    <a href="{{route('dashboard')}}">{{__('common.Dashboard')}}</a>
                    <a href="#">{{__('courses.Courses')}}</a>
                    <a class="active"
                       href="{{route('course-level.index')}}">{{__('courses.Course')}} {{__('courses.Level')}}</a>
                </div>
            </div>
        </div>
    </section>
                                ...
                                <table id="lms_table" class="table table-data">
                                    ...
                                    @foreach($levels as $key => $level)
                                        <tr>
                                            ...
                                            <td>{{@$level->title }}</td>
                                            <td class="nowrap">
                                                <x-backend.status :id="$level->id" :status="$level->status"
                                                                  :route="'course-level.changeStatus'"></x-backend.status>
                                            </td>
                                            <td>
