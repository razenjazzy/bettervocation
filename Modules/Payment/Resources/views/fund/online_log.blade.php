                    ...
                    <table id="lms_table" class="table Crm_table_active3">
                        ...
                        @foreach($onlineLogs as $log)
                            <tr>
                                ...
                                <td> {{getPriceFormat($log->price)}}</td>
                                <td>{{getPriceFormat($log->purchase_price)}}</td>
                                <td>{{getPriceFormat($log->tax)}}</td>
