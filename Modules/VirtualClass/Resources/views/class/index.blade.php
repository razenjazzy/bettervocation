        ...
        <div class="container-fluid">
            <div class="row justify-content-between">
                ...
                <div class="bc-pages">
                    ...
                    <a href="#"> {{__('virtual-class.Virtual Class')}}</a>
                    <a href="#" class="active"> {{__('virtual-class.Class List')}}</a>
                </div>
            </div>
        </div>
    </section>
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="input-effect">
                                                            ...
                                                            <input type="text"
                                                                   ...
                                                                   value="{{isset($class)? $class->getTranslation('title',$language->code):''}}">
                                        ...
                                        <div class="col-xl-12">
                                            <div class="primary_input">
                                                ...
                                                <select name="assistant_instructors[]" id="assistant_instructors"
                                                    ...
                                                    @foreach ($instructors as $instructor)
                                                        <option
                                                            value="{{$instructor->id}}" {{isset($class)&&!empty($class->course->assistantInstructorsIds) && in_array($instructor->id,$class->course->assistantInstructorsIds)?'selected':''}}>{{@$instructor->name}} </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                                        ...
                                                        <div class="col">
                                                            <div class="">
                                                                <input placeholder="End Date"
                                                                       ...
                                                                       name="end_date"
                                                                       value="{{isset($class)?  getJsDateFormat($class->end_date) : getJsDateFormat(date('m/d/Y'))}}"
                                                                       autocomplete="off">
                                                            </div>
                                                        </div>
                                                        <button class="" type="button">
                                                        ...
                                                        <div class="col">
                                                            <div class="">
                                                                <input placeholder="Date" readonly
                                                                       ...
                                                                       id="start_date" type="text"
                                                                       name="date"
                                                                       value="{{isset($class) && $class->type == 0 ? getJsDateFormat($class->start_dat) : getJsDateFormat(date('m/d/Y'))}}"
                                                                       autocomplete="off">
                                                            </div>
                                                        </div>
                                                        <button class="" type="button">
