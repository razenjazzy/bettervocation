...
class SystemSettingController extends Controller
{
    ...
    public function updateEmailSetting(Request $request)
    {
        ...
        try {
            if (Config::get('app.app_sync')) {
                ...
                SaasEnvSetting(SaasDomain(), 'MAIL_FROM_NAME', $request->from_name ?? 'BetterVocation');
                SaasEnvSetting(SaasDomain(), 'MAIL_FROM_ADDRESS', $request->from_email ?? 'admin@bettervocation.io');
    ...
    public function saveApi(Request $request)
    {
        ...
        if ($request->fcm_key) {
            SaasEnvSetting(SaasDomain(), 'FCM_SECRET_KEY', $request->fcm_key);
