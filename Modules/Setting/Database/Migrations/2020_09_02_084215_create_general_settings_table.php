...
class CreateGeneralSettingsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('general_settings', function (Blueprint $table) {
            $table->id();
            $table->string('site_title')->nullable()->default('Better Vocation');
            ...
            $table->string('copyright_text')->default('Copyright © 2022 BetterVocation. All rights reserved');
        ...
        DB::table('general_settings')->insert([
            [
                'id' => 1,
                'site_title' => 'Better Vocation',
                'address' => 'Bashundhara R/A, Dhaka 1229, Bangladesh',
                'phone' => '+8801787671962',
                'email' => 'domain@bettervocation.io',
                ...
                'zip_code' => '1205',
                'active_status' => '1',
                'copyright_text' => 'Copyright © 2022 BetterVocation. All rights reserved ',
                'footer_copy_right' => 'Copyright © 2022 BetterVocation. All rights reserved ',
