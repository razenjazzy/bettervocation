    ...
    <section class="sms-breadcrumb mb-40 white-box">
        <div class="container-fluid">
            <div class="row justify-content-between">
                <h1>{{__('setting.Preloader')}} {{__('setting.Settings')}}</h1>
                <div class="bc-pages">
                    <a href="{{route('dashboard')}}">{{__('dashboard.Dashboard')}} </a>
                    <a href="#">{{__('setting.Utility')}}</a>
                    <a href="#">{{__('setting.Preloader')}} {{__('setting.Settings')}}</a>
                </div>
            </div>
        </div>
    </section>
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-md-3 mb-25">
                                                                                        <label
                                                                                            ...
                                                                                            <span
                                                                                                class="checkmark mr-2"></span> {{__('setting.Show')}}
                                                                                    ...
                                                                                    <div class="col-md-3 mb-25">
                                                                                        <label
                                                                                            ...
                                                                                            <span
                                                                                                class="checkmark mr-2"></span> {{__('setting.Hide')}}
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-md-3 mb-25">
                                                                                        <label
                                                                                            ...
                                                                                            <span
                                                                                                class="checkmark mr-2"></span> {{__('setting.Animation')}}
                                                                                    ...
                                                                                    <div class="col-md-3 mb-25">
                                                                                        <label
                                                                                            ...
                                                                                            <span
                                                                                                class="checkmark mr-2"></span> {{__('setting.Image')}}
                                                                            ...
                                                                            <div class="col-xl-4">
                                                                                <div class="primary_input mb-25">
                                                                                    <label class="primary_input_label"
                                                                                           for="">{{ __('setting.Preloader Image') }}
                                                                                    </label>
                                                                            ...
                                                                            <div class="col-xl-2">
                                                                                <div class="primary_input mb-25 pt-4">
                                                                                    <img height="70"
                                                                                         ...
                                                                                         src="{{asset(Settings('preloader_image'))}}"
                                                                                         alt="">
                                                                                </div>
                                                                            </div>
                                                                        </div>
