...
Route::group(['prefix' => 'setting', 'middleware' => ['auth', 'admin']], function () {
    ...
    Route::get('/EmailTempAjax/{id}/{type}', 'GeneralSettingsController@EmailTempAjax')->name('EmailTempAjax')->middleware('RoutePermissionCheck:EmailTempAjax');
    ...
    Route::post('city-edit-modal', 'CityController@edit_modal')->name('city.edit_modal')->middleware('RoutePermissionCheck:city.update');
    Route::get('/city/destroy/{id}', 'CityController@destroy')->name('city.destroy')->middleware('RoutePermissionCheck:city.delete');
